...
class OSappscheduleBalance{
	...
	function balance_list($option){
        ...
        $filter_order 				= $mainframe->getUserStateFromRequest($option.'.employee.filter_order','filter_order','created_date','string');
        $filter_order_Dir 			= $mainframe->getUserStateFromRequest($option.'.employee.filter_order_Dir','filter_order_Dir','desc','string');
