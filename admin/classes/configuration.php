...
class OSappscheduleConfiguration{
	...
	function configuration_list($option){
		...
		$lists['currency_symbol_position'] = JHTML::_('select.genericlist', $options, 'currency_symbol_position', 'STYLE="width:140px;" class="input-small" ', 'value', 'text', $configs->currency_symbol_position);
		
		//get Activate Invoice Feature
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['activate_invoice_feature'] = JHTML::_('select.genericlist', $options, 'activate_invoice_feature', ' class="input-small" ', 'value', 'text', $configs->activate_invoice_feature);

		//get Send invoice to subscribers 
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['send_invoice_to_customer'] = JHTML::_('select.genericlist', $options, 'send_invoice_to_customer', ' class="input-small" ', 'value', 'text', $configs->send_invoice_to_customer);
		...
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['employee_change_availability'] = JHTML::_('select.genericlist', $options, 'employee_change_availability', ' class="input-small" ', 'value', 'text', $configs->employee_change_availability);
		...
		$lists['enable_clickatell'] = JHTML::_('select.genericlist',$optionArr,'enable_clickatell','class="input-mini"','value','text',$configs->enable_clickatell);
		
		$optionArr   = array();
		$optionArr[] = JHTML::_('select.option','1',JText::_('OS_YES'));
		$optionArr[] = JHTML::_('select.option','0',JText::_('OS_NO'));
		$lists['enable_eztexting'] = JHTML::_('select.genericlist',$optionArr,'enable_eztexting','class="input-mini"','value','text',$configs->enable_eztexting);
		...
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['show_service_info_box'] = JHTML::_('select.genericlist', $options, 'show_service_info_box', ' class="input-small" ', 'value', 'text', $configs->show_service_info_box);
		...
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['show_service_description'] = JHTML::_('select.genericlist', $options, 'show_service_description', ' class="input-small" ', 'value', 'text', $configs->show_service_description);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['show_service_photo'] = JHTML::_('select.genericlist', $options, 'show_service_photo', ' class="input-small" ', 'value', 'text', $configs->show_service_photo);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['load_bootstrap'] = JHTML::_('select.genericlist', $options, 'load_bootstrap', ' class="input-small" ', 'value', 'text', $configs->load_bootstrap);
		...
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['allow_multiple_timezones'] = JHTML::_('select.genericlist', $options, 'allow_multiple_timezones', ' class="input-mini" ', 'value', 'text', $configs->allow_multiple_timezones);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['disable_calendar_in_off_date'] = JHTML::_('select.genericlist', $options, 'disable_calendar_in_off_date', ' class="input-small" ', 'value', 'text', $configs->disable_calendar_in_off_date);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['use_js_popup'] = JHTML::_('select.genericlist', $options, 'use_js_popup', ' class="input-small" ', 'value', 'text', $configs->use_js_popup);
		
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['show_dropdown_month_year'] = JHTML::_('select.genericlist', $options, 'show_dropdown_month_year', ' class="input-small" ', 'value', 'text', $configs->show_dropdown_month_year);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['using_cart'] = JHTML::_('select.genericlist', $options, 'using_cart', ' class="input-small" ', 'value', 'text', $configs->using_cart);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['allow_registration'] = JHTML::_('select.genericlist', $options, 'allow_registration', ' class="input-small" ', 'value', 'text', $configs->allow_registration);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$lists['allow_cancel_request'] = JHTML::_('select.genericlist', $options, 'allow_cancel_request', ' class="input-small" ', 'value', 'text', $configs->allow_cancel_request);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['enable_acymailing'] = JHTML::_('select.genericlist', $options, 'enable_acymailing', ' class="input-small" ', 'value', 'text', $configs->enable_acymailing);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['integrate_user_profile'] = JHTML::_('select.genericlist', $options, 'integrate_user_profile', ' class="input-small" ', 'value', 'text', $configs->integrate_user_profile);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['show_calendar_box'] = JHTML::_('select.genericlist', $options, 'show_calendar_box', ' class="input-small" ', 'value', 'text', $configs->show_calendar_box);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['early_bird'] = JHTML::_('select.genericlist', $options, 'early_bird', ' class="input-small" ', 'value', 'text', $configs->early_bird);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['enable_slots_discount'] = JHTML::_('select.genericlist', $options, 'enable_slots_discount', ' class="input-small" ', 'value', 'text', $configs->enable_slots_discount);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['show_number_timeslots_booking'] = JHTML::_('select.genericlist', $options, 'show_number_timeslots_booking', ' class="input-small" ', 'value', 'text', $configs->show_number_timeslots_booking);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['hidetabs'] = JHTML::_('select.genericlist', $options, 'hidetabs', ' class="input-small" ', 'value', 'text', $configs->hidetabs);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['employee_bar'] = JHTML::_('select.genericlist', $options, 'employee_bar', ' class="input-small" ', 'value', 'text', $configs->employee_bar);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['service_information'] = JHTML::_('select.genericlist', $options, 'service_information', ' class="input-small" ', 'value', 'text', $configs->service_information);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
		$lists['show_employee_cost'] = JHTML::_('select.genericlist', $options, 'show_employee_cost', ' class="input-small" ', 'value', 'text', $configs->show_employee_cost);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_DEFAULT_LAYOUT'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_SIMPLER_LAYOUT'));
		$lists['using_layout'] = JHTML::_('select.genericlist', $options, 'using_layout', ' class="input-large" ', 'value', 'text', $configs->using_layout);
		
		$options = array() ;
		$options[] = JHTML::_('select.option', 0, JText::_('OS_USINGTAB'));
		$options[] = JHTML::_('select.option', 1, JText::_('OS_USINGSELECTLIST'));
		$lists['usingtab'] = JHTML::_('select.genericlist', $options, 'usingtab', ' class="input-large" ', 'value', 'text', $configs->usingtab);

        $options = array() ;
        $options[] = JHTML::_('select.option', 0, JText::_('OS_RADIO_THEME'));
        $options[] = JHTML::_('select.option', 1, JText::_('OS_SIMPLE_THEME'));
        $lists['booking_theme'] = JHTML::_('select.genericlist', $options, 'booking_theme', ' class="input-medium" ', 'value', 'text', $configs->booking_theme);

        $options = array() ;
        $options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
        $options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
        $lists['use_qrcode'] = JHTML::_('select.genericlist', $options, 'use_qrcode', ' class="input-medium" ', 'value', 'text', $configs->use_qrcode);

        $options = array() ;
        $options[] = JHTML::_('select.option', 0, JText::_('OS_CONFIGURATION_NO'));
        $options[] = JHTML::_('select.option', 1, JText::_('OS_CONFIGURATION_YES'));
        $lists['show_details_and_orders'] = JHTML::_('select.genericlist', $options, 'show_details_and_orders', ' class="input-medium" ', 'value', 'text', $configs->show_details_and_orders);
