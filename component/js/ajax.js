...
function loadServicesAjax(live_site,year,month,day){
	...
	url = live_site + "index.php?option=com_osservicesbooking&tmpl=component&no_html=1&task=ajax_loadServices&year=" + year + "&month=" + month + "&day=" + day + "&category_id=" + catid + "&employee_id=" + eid + "&vid=" + vid + "&sid=" + sid;  
