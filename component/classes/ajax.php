...
class OsAppscheduleAjax{
	...
	function display($option,$task){
		...
		switch ($task){
			...
			case "ajax_loadServices":
				...
				$count_services		= JRequest::getInt('count_servics',0);
	...
	static function addToCart($option){
		...
		$db->setQuery("SELECT COUNT(o.id) FROM #__app_sch_temp_orders o INNER JOIN #__app_sch_temp_order_items oi where o.unique_cookie like '$unique_cookie'");
